...
mac { 
	...
	LIBS += ../Libraries/boost_1_55_0/stage/lib/libboost_thread.a
	LIBS += ../Libraries/boost_1_55_0/stage/lib/libboost_filesystem.a
	LIBS += ../Libraries/boost_1_55_0/stage/lib/libboost_regex.a
	LIBS += ../Libraries/boost_1_55_0/stage/lib/libboost_random.a
	LIBS += ../Libraries/boost_1_55_0/stage/lib/libboost_system.a
	LIBS += ../Libraries/boost_1_55_0/stage/lib/libboost_iostreams.a
	LIBS += /opt/local/lib/libgsasl.dylib
	#LIBS += ../Libraries/tinyxml-copiaxcode/libtinyxml.dylib
	...
	LIBPATH += /Developer/SDKs/MacOSX10.7.sdk/usr/lib
	INCLUDEPATH += /Developer/SDKs/MacOSX10.7.sdk/usr/include/
