...
int main( int argc, char **argv )
{
    ...
    qInfo("myAppDataPath--");
    qInfo(myAppDataPath.toLatin1());
    

  //  QDirIterator it3(myAppDataPath, QDirIterator::Subdirectories);
   // while (it3.hasNext()) {
    //    qDebug() << it3.next();
    //}
    ...
    //myConfig->writeConfigString("LogDir", argv[0]);
    QString	myLogDataPath = QString::fromUtf8((myConfig->readConfigString("LogDir")).c_str());
    qInfo("logDir--");
    qInfo(myLogDataPath.toLatin1());
