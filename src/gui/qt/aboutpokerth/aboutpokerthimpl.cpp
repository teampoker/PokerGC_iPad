...
#endif
	//label_pokerthVersion->setText(QString(tr("TeamPoker %1 for Android (API%2)").arg(POKERTH_BETA_RELEASE_STRING).arg(api)));
	label_pokerthVersion->setText(QString(tr("TEAM POKER® %1 for Android (API%2)").arg(POKERTH_BETA_RELEASE_STRING).arg(api)));
#else
	//label_pokerthVersion->setText(QString(tr("TeamPoker %1").arg(POKERTH_BETA_RELEASE_STRING)));
	label_pokerthVersion->setText(QString(tr("TEAM POKER® %1").arg(POKERTH_BETA_RELEASE_STRING)));
#endif
	//this->setWindowTitle(QString(tr("About TeamPoker %1").arg(POKERTH_BETA_RELEASE_STRING)));
	this->setWindowTitle(QString(tr("About TEAM POKER® %1").arg(POKERTH_BETA_RELEASE_STRING)));
