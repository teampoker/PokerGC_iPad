...
void settingsDialogImpl::prepareDialog()
{
	...
	defaultTableStyle.readStyleFile(QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/gui/table/teampoker/teampoker.xml");
	if(defaultTableStyle.getLoadedSuccessfull()) {
		QStringList tempStringList1;
		tempStringList1 << defaultTableStyle.getStyleDescription() << defaultTableStyle.getStyleMaintainerName();
		MyStyleListItem *defaultTableItem = new MyStyleListItem(tempStringList1, treeWidget_gameTableStyles);
		...
		defaultTableItem->setData(0, 15, QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/gui/table/teampoker/teampoker.xml");
		defaultTableItem->setData(0, 16, POKERTH_DISTRIBUTED_STYLE);
		...
		defaultTableItem->setData(0, Qt::ToolTipRole, QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/gui/table/teampoker/teampoker.xml");
		defaultTableItem->setData(2, Qt::ToolTipRole, defaultTableStyle.getMyStateToolTipInfo());
		if(defaultTableStyle.getState()) defaultTableItem->setIcon(2, QIcon(":/gfx/emblem-important.png"));
		else defaultTableItem->setIcon(2, QIcon(":/gfx/dialog_ok_apply.png"));
	}
	...
	//add TeamPoker additional table 1
	GameTableStyleReader teampoker_table1(myConfig, this);
	teampoker_table1.readStyleFile(QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/gui/table/teampoker_1/teampoker.xml");
	if(teampoker_table1.getLoadedSuccessfull()) {
		QStringList tempStringList2;
		tempStringList2 << teampoker_table1.getStyleDescription() << teampoker_table1.getStyleMaintainerName();
		MyStyleListItem *teampoker1TableItem = new MyStyleListItem(tempStringList2, treeWidget_gameTableStyles);
		teampoker1TableItem->setData(0, 15, QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/gui/table/teampoker_1/teampoker.xml");
		teampoker1TableItem->setData(0, 16, POKERTH_DISTRIBUTED_STYLE);
		teampoker1TableItem->setData(0, Qt::ToolTipRole, QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/gui/table/teampoker_1/teampoker.xml");
		teampoker1TableItem->setData(2, Qt::ToolTipRole, teampoker_table1.getMyStateToolTipInfo());
		if(teampoker_table1.getState()) teampoker1TableItem->setIcon(2, QIcon(":/gfx/emblem-important.png"));
		else teampoker1TableItem->setIcon(2, QIcon(":/gfx/dialog_ok_apply.png"));
	}
	
	
	//add TeamPoker additional table 2
	GameTableStyleReader teampoker_table2(myConfig, this);
	teampoker_table2.readStyleFile(QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/gui/table/teampoker_2/teampoker.xml");
	if(teampoker_table2.getLoadedSuccessfull()) {
		QStringList tempStringList2;
		tempStringList2 << teampoker_table2.getStyleDescription() << teampoker_table2.getStyleMaintainerName();
		MyStyleListItem *teampoker2TableItem = new MyStyleListItem(tempStringList2, treeWidget_gameTableStyles);
		teampoker2TableItem->setData(0, 15, QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/gui/table/teampoker_2/teampoker.xml");
		teampoker2TableItem->setData(0, 16, POKERTH_DISTRIBUTED_STYLE);
		teampoker2TableItem->setData(0, Qt::ToolTipRole, QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/gui/table/teampoker_2/teampoker.xml");
		teampoker2TableItem->setData(2, Qt::ToolTipRole, teampoker_table2.getMyStateToolTipInfo());
		if(teampoker_table2.getState()) teampoker2TableItem->setIcon(2, QIcon(":/gfx/emblem-important.png"));
		else teampoker2TableItem->setIcon(2, QIcon(":/gfx/dialog_ok_apply.png"));
	}
	
	//add TeamPoker additional table 3
	GameTableStyleReader teampoker_table3(myConfig, this);
	teampoker_table3.readStyleFile(QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/gui/table/teampoker_3/teampoker.xml");
	if(teampoker_table3.getLoadedSuccessfull()) {
		QStringList tempStringList2;
		tempStringList2 << teampoker_table3.getStyleDescription() << teampoker_table3.getStyleMaintainerName();
		MyStyleListItem *teampoker3TableItem = new MyStyleListItem(tempStringList2, treeWidget_gameTableStyles);
		teampoker3TableItem->setData(0, 15, QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/gui/table/teampoker_3/teampoker.xml");
		teampoker3TableItem->setData(0, 16, POKERTH_DISTRIBUTED_STYLE);
		teampoker3TableItem->setData(0, Qt::ToolTipRole, QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/gui/table/teampoker_3/teampoker.xml");
		teampoker3TableItem->setData(2, Qt::ToolTipRole, teampoker_table3.getMyStateToolTipInfo());
		if(teampoker_table3.getState()) teampoker3TableItem->setIcon(2, QIcon(":/gfx/emblem-important.png"));
		else teampoker3TableItem->setIcon(2, QIcon(":/gfx/dialog_ok_apply.png"));
	}
#endif
	...
	defaultCardStyle10.readStyleFile(QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/cards/teampoker/teampoker.xml");
	if(defaultCardStyle10.getLoadedSuccessfull()) {
		...
		defaultCardItem->setData(0, 15, QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/cards/teampoker/teampoker.xml");
		...
		defaultCardItem->setData(0, Qt::ToolTipRole, QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/cards/teampoker/teampoker.xml");
	...
	//define teampoker cards 1
	CardDeckStyleReader defaultCardStyle(myConfig, this);
	defaultCardStyle.readStyleFile(QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/cards/teampoker_1/teampoker.xml");
	if(defaultCardStyle.getLoadedSuccessfull()) {
		...
		MyStyleListItem *defaultCardItem = new MyStyleListItem(tempStringList1, treeWidget_cardDeckStyles);
		defaultCardItem->setData(0, 15, QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/cards/teampoker_1/teampoker.xml");
		defaultCardItem->setData(0, 16, POKERTH_DISTRIBUTED_STYLE);
		defaultCardItem->setData(0, Qt::ToolTipRole, QString::fromUtf8(myConfig->readConfigString("AppDataDir").c_str())+"gfx/cards/teampoker_1/teampoker.xml");
...
{
	int ret = MyMessageBox::warning(this, tr("TEAMPOKER® - Settings"),
									tr("Attention: this will delete all your personal settings and close TEAMPOKER®!\n"
